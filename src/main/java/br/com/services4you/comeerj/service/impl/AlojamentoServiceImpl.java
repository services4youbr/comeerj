...
public class AlojamentoServiceImpl implements AlojamentoService {
    ...
    private final AlojamentoSearchRepository alojamentoSearchRepository;

    public AlojamentoServiceImpl(AlojamentoRepository alojamentoRepository, AlojamentoMapper alojamentoMapper, AlojamentoSearchRepository alojamentoSearchRepository) {
        this.alojamentoRepository = alojamentoRepository;
        this.alojamentoMapper = alojamentoMapper;
        this.alojamentoSearchRepository = alojamentoSearchRepository;
    }
    ...
    public AlojamentoDTO save(AlojamentoDTO alojamentoDTO) {
        ...
        AlojamentoDTO result = alojamentoMapper.toDto(alojamento);
    ...
    public void delete(Long id) {
        ...
        alojamentoSearchRepository.delete(id);
    }
    ...
    @Override
    @Transactional(readOnly = true)
    public Page<AlojamentoDTO> search(String query, Pageable pageable) {
        log.debug("Request to search for a page of Alojamentos for query {}", query);
        Page<Alojamento> result = alojamentoSearchRepository.search(queryStringQuery(query), pageable);
        return result.map(alojamentoMapper::toDto);
    }
}
