...
describe('Service Tests', () => {
    ...
    describe('FaixaEtariaComeerj Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(FaixaEtariaComeerjService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/faixa-etarias';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return FaixaEtariaComeerj', () => {
