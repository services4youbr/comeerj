...
describe('Service Tests', () => {
    ...
    describe('AlojamentoComeerj Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(AlojamentoComeerjService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/alojamentos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return AlojamentoComeerj', () => {
