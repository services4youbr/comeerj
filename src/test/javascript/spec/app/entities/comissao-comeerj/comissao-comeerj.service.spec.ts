...
describe('Service Tests', () => {
    ...
    describe('ComissaoComeerj Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ComissaoComeerjService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/comissaos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ComissaoComeerj', () => {
