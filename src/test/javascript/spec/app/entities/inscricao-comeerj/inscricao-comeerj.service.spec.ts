...
describe('Service Tests', () => {
    ...
    describe('InscricaoComeerj Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(InscricaoComeerjService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/inscricaos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return InscricaoComeerj', () => {
